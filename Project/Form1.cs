...
namespace GLA_Management_System
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            idno = textBox1.Text;
            psw= textBox2.Text;
            SqlConnection connection = new SqlConnection("Data Source=LENOVO\\SQLEXPRESS;Initial Catalog=\"GLAU database\";Integrated Security=True");
            connection.Open();
            prs = comboBox1.Text;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into " + db + " values(@u,@p)", connection);
